...
var s1 = new THREE.Mesh(sphereGeometry, material);
scene.add(s1);

var c1 = new THREE.Mesh(cylinderGeometry, material);
s1.add(c1);

var s2 = new THREE.Mesh(sphereGeometry, material);
c1.add(s2);

var c2 = new THREE.Mesh(cylinderGeometry, material);
s2.add(c2);

var s3 = new THREE.Mesh(sphereGeometry, material);
c2.add(s3);
